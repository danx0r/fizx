...
for (i=0; i<36; i++) {
  ...
  var testSquare = new square("square", 300, 450, 0, 0, 40,10);
  var testSquare2 = new square("square2", 100, 450, 0, 0, 100,10);
  var testSquare3 = new square("square3", 250, 450, 0, 0, 40,10);
