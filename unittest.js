...
console.log("bond_all pass:",
            Math.abs(ATOMS[0].p.x - 210.9189584235222) < 0.000001 &&
            Math.abs(ATOMS[0].p.y - 183.01497863415136) < 0.000001 &&
            Math.abs(ATOMS[0].v.x - -0.003318566665677476) < 0.000001 &&
            Math.abs(ATOMS[0].v.y - -0.0003982908340217825) < 0.000001
            );
